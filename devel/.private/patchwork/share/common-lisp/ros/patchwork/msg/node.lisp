...
(cl:defmethod cl:initialize-instance :after ((m <node>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name patchwork-msg:<node> is deprecated: use patchwork-msg:node instead.")))

(cl:ensure-generic-function 'idx-val :lambda-list '(m))
(cl:defmethod idx-val ((m <node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader patchwork-msg:idx-val is deprecated.  Use patchwork-msg:idx instead.")
  (idx m))
...
(cl:defmethod pose-val ((m <node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader patchwork-msg:pose-val is deprecated.  Use patchwork-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'lidar-val :lambda-list '(m))
(cl:defmethod lidar-val ((m <node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader patchwork-msg:lidar-val is deprecated.  Use patchwork-msg:lidar instead.")
  (lidar m))

(cl:ensure-generic-function 'ground_estimate-val :lambda-list '(m))
(cl:defmethod ground_estimate-val ((m <node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader patchwork-msg:ground_estimate-val is deprecated.  Use patchwork-msg:ground_estimate instead.")
  (ground_estimate m))
